		...
		<div class="guest-view" in:fade>
			<div class="hero-section">
				...
				<div class="google-auth-container">
					<div class="recommended-badge">✨ Recommended for instant access</div>
					<button class="auth-btn google-btn primary" on:click={onGoogleLogin} disabled={isLoggingIn}>
				...
				<div class="phone-auth-container">
					<button class="auth-btn whatsapp-btn secondary" on:click={onWhatsAppLogin}>
						<MessageCircle size={20} class="whatsapp-icon" />
						Continue with WhatsApp
					</button>
					<p class="whatsapp-hint">We'll send you a login link via WhatsApp</p>
				</div>
			</div>
...
<style>
	...
	.phone-auth-container, .google-auth-container {
		max-width: 320px;
		margin: 0 auto;
	}
</style>
