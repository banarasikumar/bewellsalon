...
<section class="about-section container section-padding" id="about">
...
<style>
	...
	.premium-badge {
		background: linear-gradient(90deg, rgba(212, 175, 55, 0.1), rgba(212, 175, 55, 0.2));
